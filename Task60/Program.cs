...
// Метод создания одномерного возрастающего массива из неповторяющихся чисел:
...
int [,,] GetTripleArray(int depth, int rows, int columns)
{
    ...
    // Создание одномерного массива двузначных чисел:
    ...
    Random randomValue = new Random();
        for (int i = 0; i < array.GetLength(0); i++)
        {
            for (int j = 0; j < array.GetLength(1); j++)
            {
                ...
                {
                    arrayRandomIndex = randomValue.Next(109, 198); // Положительные двузначные числа:
